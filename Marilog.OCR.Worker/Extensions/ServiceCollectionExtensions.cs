...
namespace Marilog.OCR.Worker.Extensions;
...
public static class ServiceCollectionExtensions
{
    ...
    /// </summary>
    public static IServiceCollection AddSearchablePdfGenerator(this IServiceCollection services, Action<OcrServiceOptions>? configure = null)
    {
